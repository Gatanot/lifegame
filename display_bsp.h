...
#define AlgorithmOptimization 3  // 1: Division 2: Bit-shift 3: Lookup-Table
...
public:
  ...
  void RLCD_FillBlock4(uint16_t gx, uint16_t gy, uint8_t color);
  void RLCD_FillBlock2(uint16_t gx, uint16_t gy, uint8_t color);
#endif
};
